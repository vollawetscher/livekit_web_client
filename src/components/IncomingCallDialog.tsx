  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 z-50 flex flex-col items-center justify-center text-white">
      ...
      <div className="relative z-10 flex flex-col items-center space-y-8 animate-fade-in">
        <div className="text-lg font-medium opacity-90">Incoming Call</div>
        ...
        <div className="relative">
          {callerAvatar ? (
            <img
              src={callerAvatar}
              alt={callerName}
              className="w-32 h-32 rounded-full object-cover border-4 border-white shadow-2xl animate-pulse-slow"
            />
          ) : (
            <div className="w-32 h-32 rounded-full bg-white bg-opacity-20 backdrop-blur-sm border-4 border-white shadow-2xl flex items-center justify-center animate-pulse-slow">
              <User className="w-16 h-16 text-white" />
            </div>
          )}

          <div className="absolute inset-0 rounded-full border-4 border-white opacity-30 animate-ping" style={{ animationDuration: '2s' }} />
        </div>

        <div className="text-center">
          <h2 className="text-4xl font-bold mb-2">{callerName}</h2>
          <p className="text-lg opacity-90">wants to video call you</p>
        </div>
        ...
        <div className="flex items-center space-x-8 mt-8">
          ...
          >
            <div className="w-16 h-16 rounded-full bg-red-500 hover:bg-red-600 flex items-center justify-center shadow-xl transition-colors">
          ...
          <button
            ...
            className="group flex flex-col items-center space-y-3 transition-transform hover:scale-110"
          >
            <div className="w-16 h-16 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center shadow-xl transition-colors animate-bounce-slow">
